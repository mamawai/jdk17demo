...
public class 大数组元素的乘积 {
    public static void main(String[] args) {
        int[] productsOfElements = new Solution3145().findProductsOfElements(new long[][]{{2,7,3}});
        for (int productsOfElement : productsOfElements) {
            System.out.println(productsOfElement);
        }
    }
}
